...
const i18n = {
  zh: {
    ...
    libraryPaperTitle: "上传已发表英文论文（参考）",
    libraryPaperHint: "支持 PDF/DOCX/TXT，用于提取已发表英文论文内容。",
  ...
  en: {
    ...
    libraryPaperTitle: "Upload Published English Papers (References)",
    libraryPaperHint: "Supports PDF/DOCX/TXT and extracts content from published English papers.",
