...
This repository is a lightweight multi-page UI with a small Node server.
...
- `server.js`: Node HTTP server serving static files and mock APIs.
...
- `node server.js`: run the local server at `http://localhost:8787`.
